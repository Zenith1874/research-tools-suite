...
MOF_CENTRAL_DEBT_PDFS = [
    ...
    {'url': 'https://gks.mof.gov.cn/tongjishuju/202603/P020260325523419801269.pdf',
     'title': '2025年中央政府月度收支及融资数据和季度债务余额情况',
     'periods': ['2025-03', '2025-06', '2025-09', '2025-12'], 'published': '2026-03-25'},
]
